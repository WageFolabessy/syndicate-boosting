...
class ApexLegendGameRankTierSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Untuk Apex Legends, kita asumsikan sistemnya berbasis point,
        // dan subdivisi diurutkan sedemikian rupa sehingga Tier I adalah subdivisi tertinggi.
        // Di sini, kita tetapkan nilai progress_target secara bertingkat:
        $tiers = [
            // Rookie (urut dari Tier IV – terendah, ke Tier I – tertinggi)
            [
