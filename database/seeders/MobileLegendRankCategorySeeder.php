    ...
    public function run(): void
    {
        $mobileLegendsRankCategories = [
            [
                ...
                'image'         => public_path('images/mobile-legends/1-warrior.png'),
                'display_order' => 1,
                'system_type'   => 'star',
            ],
            [
                'game_id'       => 2,
                'name'          => ucfirst('elite'),
                'image'         => public_path('images/mobile-legends/2-elite.png'),
                'display_order' => 2,
                'system_type'   => 'star',
            ],
            [
                'game_id'       => 2,
                'name'          => ucfirst('master'),
                'image'         => public_path('images/mobile-legends/3-master.png'),
                'display_order' => 3,
                'system_type'   => 'star',
            ],
            [
                'game_id'       => 2,
                'name'          => 'GM',
                'image'         => public_path('images/mobile-legends/4-gm.png'),
                'display_order' => 4,
                'system_type'   => 'star',
            ],
            [
                'game_id'       => 2,
                'name'          => ucfirst('epic'),
                'image'         => public_path('images/mobile-legends/5-epic.png'),
                'display_order' => 5,
                'system_type'   => 'star',
            ],
            [
                'game_id'       => 2,
                'name'          => ucfirst('legend'),
                'image'         => public_path('images/mobile-legends/6-legend.png'),
                'display_order' => 6,
                'system_type'   => 'star',
            ],
            // [
            //     'game_id'       => 2,
            //     'name'          => ucfirst('mythic'),
            //     'image'         => public_path('images/mobile-legends/7-mythic.png'),
            //     'display_order' => 7,
            //     'system_type'   => 'star',
            // ],
        ];
