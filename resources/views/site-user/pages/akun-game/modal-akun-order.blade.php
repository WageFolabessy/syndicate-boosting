        ...
        <div class="modal-content border-0 rounded-3 overflow-hidden">
            ...
            <div class="modal-header bg-gradient-primary text-white position-relative">
                <div class="w-100 text-center">
                    ...
                    <h5 class="modal-title fs-4 fw-bold mb-2" id="orderAccountModalLabel">
                        Pemesanan Akun Game
                    </h5>
            ...
            <div class="modal-body p-4 p-lg-5">
                <form id="orderAccountForm" class="needs-validation">
                    <div class="row g-4">
                        <!-- Nama Panggilan -->
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input type="text" class="form-control rounded-3" id="customer_name"
                                    name="customer_name" required placeholder="08123456789">
                                <label for="customer_name" class="text-muted">
                                    <i class="bi bi-person me-2"></i>Nama Panggilan Anda
...
<input type="hidden" id="game_account_id" value="{{ $account->id }}">
<input type="hidden" id="price" value="{{ $account->sale_price ?? $account->original_price }}">
