        ...
        <div class="content-container">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a id="btnExport" href="{{ route('dashboard.custom-boosting-transaction.export') }}" class="btn btn-outline-primary">
...
@section('script')
    ...
    <script src="{{ asset('assets/dashboard/js/transaction/custom-boosting-transaction.js') }}?v={{ now()->timestamp }}"></script>
@endsection
