    ...
    <main class="main-content" id="main-content">
        <div class="content-container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="mb-0 fw-bold">Edit Rank Tier Detail</h1>
                <div>
            ...
            <!-- Edit Rank Tier Detail Form -->
            <div class="form-card">
                <div class="form-header">
                    <h5 class="mb-0">Rank Tier Detail Information</h5>
                </div>
                <div class="form-container">
                    <form id="editRankTierDetailForm" action="{{ route('dashboard.rank-tier-detail.update', $detail->id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row g-4">
                            <div class="col-12">
                                    ...
                                    <select class="form-select" name="game_rank_tier_id" id="game_rank_tier_id" required>
                                        ...
                                        @foreach ($rankTiers as $tier)
                                            <option value="{{ $tier->id }}"
                                                {{ old('game_rank_tier_id', $detail->game_rank_tier_id) == $tier->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="price" id="price"
                                        placeholder="Enter price" value="{{ old('price', $detail->price) }}">
                                </div>
                ...
                <div class="form-footer d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" form="editRankTierDetailForm" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>Update Rank Tier Detail
                    </button>
                </div>
            </div>
        </div>
