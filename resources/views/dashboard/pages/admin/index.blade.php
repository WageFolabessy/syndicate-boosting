    ...
    <main class="main-content" id="main-content">
        <div class="content-container">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
                <h1 class="mb-3 mb-md-0 fw-bold">Admins Management</h1>
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('dashboard.admin.export') }}" class="btn btn-outline-primary">
            ...
            <div class="table-card">
                <div class="table-header">
                    <h5 class="table-title">All Admins</h5>
                </div>
...
@section('script')
    ...
    <script src="{{ asset('assets/dashboard/js/admin/index.js') }}"></script>
@endsection
